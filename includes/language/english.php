...
$txt['admin_path_to_files_folder_tip'] = "Files folder is used to store all generated files by TeamPass and also some uploaded files. IMPORTANT: for security reason, this folder should not be in the WWW folder of your website. It should be set in a protected area with a specific redirection rule in your Server configuration. IMPORTANT 2:It could be good to set a CRON task in order to clean up periodically this folder.";
$txt['admin_path_to_upload_folder_tip'] = "Upload folder is used to store all uploaded files associated to Items.<br />IMPORTANT: for security reason, this folder should not be in the WWW folder of your website. It should be set in a protected area with a specific redirection rule in your Server configuration.<br />IMPORTANT 2:This folder should never be clean up! Those files are associated to the Items.";
...
$txt['admin_setting_enable_delete_after_consultation_tip'] = "When enabled, the Item creator can decide that Item will be automatically deleted after being seen X times.";
...
$txt['nb_items_by_query_tip'] = "More items means more time to display the list.Set to 'auto' to let the tool to adapt this number depending on the size screen of the user.Set to 'max' to force to display the complet list in one time.Set a number corresding to the number of items to get at each query iterration.";
...
$txt['copy_to_clipboard_small_icons_tip'] = "This could help preventing memory usage if users have no recent computer.<br /> Indeed, the clipboard is not loaded with items informations. But no quick copy of password and login is possible.";
...
$txt['settings_anyone_can_modify_tip'] = "When activated, this will add a checkbox in the item form that permits the creator to allow the modification of this item by anyone.";
$txt['settings_default_language'] = "Define the Default Language";
$txt['settings_kb'] = "Enable Knowledge Base (beta)";
$txt['settings_kb_tip'] = "When activated, this will add a page where you can build your knowledge base.";
...
$txt['settings_ldap_domain_controler_tip'] = "Specifiy multiple controllers if you would like the class to balance the LDAP queries amongst multiple servers. You must delimit the domains by a comma (,)! By example: domain_1,domain_2,domain_3";
...
$txt['settings_richtext_tip'] = "This will activate a richtext with BBCodes in description field.";
$txt['settings_send_stats'] = "Send monthly statistics to author for better understand your usage of TeamPass";
$txt['settings_send_stats_tip'] = "These statistics are entirely anonymous! Your IP is not sent, just the following data are transmitted: amount of Items, Folders, Users, TeamPass version, personal folders enabled, ldap enabled. Many thanks if you enable those statistics. By this you help me further develop TeamPass.";
